...
function Subgraph(props) {
  ...
  return (
      <>
          ...
          <div style={{ margin: "auto", marginTop: 32 }}>
            Instead, you can use <a href="https://thegraph.com/docs/introduction" target="_blank" rel="noopener noreferrer">The Graph</a> with 🏗 multi-sig (<a href="https://youtu.be/T5ylzOTkn-Q" target="_blank">learn more</a>):
          </div>
